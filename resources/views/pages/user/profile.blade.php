                        ...
                        <div class="card-body box-profile">
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                                <li class="list-group-item">
                                    <b>Đơn hàng</b> <a class="float-right">1,322</a>
                                </li>
                                <li class="list-group-item">
                                    <b>Like sản phẩm</b> <a class="float-right">543</a>
                                </li>
                                <li class="list-group-item">
                    ...
                    <div class="card">
                        <div class="card-header p-2">
                            <ul class="nav nav-pills">
                                @foreach ($navProfile as $nav)
                                    <li class="nav-item me-2 "><a class="nav-link" href="{{ $nav['url'] }}" data-toggle="tab">{{ $nav['title'] }}</a></li>
                                @endforeach
                            </ul>
                        </div><!-- /.card-header -->
                        <div class="card-body">
