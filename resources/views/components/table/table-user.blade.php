...
<x-Table :columnNames="$columnNames" :dataTable="$dataTable">
    ...
    <tr>
        ...
        <td>
            ...
            <x-Button data-value="{{route('destroy-user',$value->id)}}" id="btnModalMassage" data-bs-toggle="modal" data-bs-target="#modalMassage" class="btn-danger">
            ...
            <x-Button data-value="{{route('delete-user',$value->id)}}" id="btnModalMassage" data-bs-toggle="modal" data-bs-target="#modalMassage" class="btn-danger">
                <i class="bi bi-trash-fill"></i>
            </x-Button>
            @endif
        </td>
