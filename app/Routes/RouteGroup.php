...
class RouteGroup
{
    ...
    function admin()
    {
        ...
        Route::middleware(['auth', 'can:VIEW_ADMIN'])->group(function () {
            ...
            Route::prefix('mail')->group(base_path('routes/includes/mailRoute.php'));
            ...
            Route::prefix('file')->group(base_path('routes/includes/fileRoute.php'));
            Route::prefix('notification')->group(base_path('routes/includes/notificationRoute.php'));
        });
    }
}
